...
<?php if($contact): ?>
	<div class="contact-details well<?php echo $params->get('classSfx'); ?>" itemscope itemtype="https://schema.org/Person">
	
	<div class="row">
		<?php if($params->get('showImage') && $params->get('positionImage') && $contact->image):  ?>
			<div class="contact-image col-xs-12 col-sm-2">
				<img src="<?php echo $contact->image; ?>" class="img-reponsive" alt="<?php echo $contact->name; ?>" itemprop="image" />
			</div>
		<?php endif;?>
		<div class="contact-info col-xs-12 col-sm-10">
		...
		<?php if($params->get('showImage') && !$params->get('positionImage') && $contact->image):  ?>
			<div class="contact-image col-xs-12 col-sm-2">
				<img src="<?php echo $contact->image; ?>" class="img-thumbnail img-reponsive pull-right" alt="<?php echo $contact->name; ?>" itemprop="image" />
			</div>
		<?php endif;?>
	</div> <!-- /row -->
